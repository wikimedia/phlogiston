...
CREATE TABLE velocity (
    ...
    nom_count_vel int,
    pes_count_vel int,
    opt_points_total_growrate int,
    nom_points_total_growrate int,
    pes_points_total_growrate int,
    opt_count_total_growrate int,
    nom_count_total_growrate int,
    pes_count_total_growrate int,
    opt_points_fore int,
    nom_points_fore int,
    pes_points_fore int,
    opt_count_fore int,
    nom_count_fore int,
    pes_count_fore int,
    threem_points_growrate int,
    threew_points_growrate int,
    threem_count_growrate int,
    threew_count_growrate int,
